...
if($_SESSION['fileview'] == 0)
{
	...
	foreach($data as $file)
	{
		...
		if(is_dir($current_dir . $file))
		{
			...
			$line .= "<a title=\"{$lng['delete']}\"    class=\"fbdelete\"    href=\"filebrowser.php?action=deldir&amp;dir=$rdir$sid\" onclick=\"return showConfirm( this.href, 'fdel' );\"><img src=\"{$imagedir}editdelete.png\" alt=\"K\" /></a>";
		...
		else
		{
			...
			$line .= "<a title=\"{$lng['delete']}\"    class=\"fbdelete\"    href=\"filebrowser.php?action=delfile&amp;file=$rdir$sid\" onclick=\"return showConfirm( this.href, 'fdel' );\"><img src=\"{$imagedir}editdelete.png\" alt=\"K\" /></a>";
