...
class BoxArea
{
	...
	public function renderBoxTrafficStats($pos, $anz)
	{
                ...
                $trafficDown = $global['downtraffic'];
                $trafficUp = $global['uptraffic'];
                ...
                $box .= "<div class=\"label\"><img src=\"{$imagedir}max_up.png\" alt=\"Up\" /></div><div id=\"boxtrfup\" class=\"traffic\">{$trafficUpDisplay}</div>";
                $box .= "<div class=\"label\"><img src=\"{$imagedir}max_down.png\" alt=\"Down\" /></div><div id=\"boxtrfdown\" class=\"traffic\">{$trafficDownDisplay}</div>";
                $box .= "<div class=\"label\"><img src=\"{$imagedir}equal.png\" alt=\"Total\" /></div><div id=\"boxtrftotal\" class=\"traffic\">{$trafficSumDisplay}</div>";
                $box .= "</div></div>";
   	...
   	switch($boxname)
		{
			...
			case BoxArea::BOX_ONLINELIST:
		 	...
		 	case BoxArea::BOX_TRAFFIC:
                                return $this->renderBoxTrafficStats($pos, $anz);
		}
	}
